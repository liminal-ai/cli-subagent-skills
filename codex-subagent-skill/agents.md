...
6. Upload release assets:
   - `gh release create vX.Y.Z dist/codex-subagent-vX.Y.Z.zip dist/codex-subagent-vX.Y.Z.skill --repo liminal-ai/codex-subagent-skill --title "vX.Y.Z" --notes "Release vX.Y.Z."`
   - or, if the release exists:
   - `gh release upload vX.Y.Z dist/codex-subagent-vX.Y.Z.zip dist/codex-subagent-vX.Y.Z.skill --repo liminal-ai/codex-subagent-skill --clobber`
