...
6. Upload release assets:
   - `gh release create vX.Y.Z dist/cursor-subagent-vX.Y.Z.zip dist/cursor-subagent-vX.Y.Z.skill --repo liminal-ai/cursor-subagent-skill --title "vX.Y.Z" --notes "Release vX.Y.Z."`
   - or, if the release exists:
   - `gh release upload vX.Y.Z dist/cursor-subagent-vX.Y.Z.zip dist/cursor-subagent-vX.Y.Z.skill --repo liminal-ai/cursor-subagent-skill --clobber`
