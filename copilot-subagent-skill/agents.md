...
Required release asset per version tag `copilot-subagent-vX.Y.Z`:
...
6. Upload release assets:
   - `gh release create copilot-subagent-vX.Y.Z dist/copilot-subagent-vX.Y.Z.zip --repo <owner>/<monorepo> --title "copilot-subagent vX.Y.Z" --notes "Release copilot-subagent vX.Y.Z."`
   - or, if the release exists:
   - `gh release upload copilot-subagent-vX.Y.Z dist/copilot-subagent-vX.Y.Z.zip --repo <owner>/<monorepo> --clobber`
