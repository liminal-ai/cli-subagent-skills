...
5. Publish artifacts to GitHub Release:
   - If creating new release:
     - `gh release create copilot-subagent-v<version> dist/copilot-subagent-v<version>.zip --repo <owner>/<monorepo> --title "copilot-subagent v<version>" --notes "Release copilot-subagent v<version>."`
   - If release already exists:
     - `gh release upload copilot-subagent-v<version> dist/copilot-subagent-v<version>.zip --repo <owner>/<monorepo> --clobber`
