...
Required assets per version tag `claude-subagent-vX.Y.Z`:
...
6. Upload release assets:
   - `gh release create claude-subagent-vX.Y.Z dist/claude-subagent-vX.Y.Z.zip dist/claude-subagent-vX.Y.Z.skill --repo <owner>/<monorepo> --title "claude-subagent vX.Y.Z" --notes "Release claude-subagent vX.Y.Z."`
   - or, if the release exists:
   - `gh release upload claude-subagent-vX.Y.Z dist/claude-subagent-vX.Y.Z.zip dist/claude-subagent-vX.Y.Z.skill --repo <owner>/<monorepo> --clobber`
